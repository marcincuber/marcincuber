...
[![X](https://img.shields.io/badge/X-@marcincuber-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/marcincuber)
...
name:           Marcin Cuber
location:       London, UK
github:         github.com/marcincuber
linkedin:       linkedin.com/in/marcincuber
focus:          Cloud Platform · DevSecOps · SRE · GitOps · FinOps
philosophy:     "Any fool can write code that a computer can understand.
...
| Prefect Associate Certification | Prefect Cloud |
...
<div align="center">
<sub>⚡ Principal Cloud Engineer · AWS · Kubernetes · Terraform · GitOps · DevSecOps · London, UK</sub>
</div>

<!--
**marcincuber/marcincuber** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
